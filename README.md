...
in the front facing package `flutter_sensors_plugin` example. 
...
```sh
cd flutter_sensors_plugin/example
fluttium test flows/test_platform_name.yaml
```

[coverage_badge]: flutter_sensors_plugin/coverage_badge.svg
